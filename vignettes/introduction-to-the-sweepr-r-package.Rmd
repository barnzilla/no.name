...
utils::install.packages(
  pkgs = "https://github.com/barnzilla/r-package-sources/raw/master/sweepr_0.11.7.tar.gz",
  repos = NULL, 
  type = "source"
)
```
...
```{r}
get_scatter_plot(
  x = outcomes_summary_df$delta.overwrite, 
  y = outcomes_summary_df$maxInc, 
  height = 500, 
  width = 756
)
```
...
get_tornado_plot(
  ...
  parameters = parameters_swept, 
  outcomes = outcomes_summary_df, 
  height = 500, 
  width = 756
)
```
